            ...
            <form action="{{ route('rute.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($buses as $bus)
                                            <option {{ old('bus_id') == $bus->id ? 'selected' : null }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="rute_awal" data-rute-awal="{{ old('rute_awal') }}" id="ruteAwal"
                                        data-dropdown-css-class="select2-lightblue" style="width: 100%;" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="rute_akhir" data-rute-akhir="{{ old('rute_akhir') }}" id="ruteAkhir"
                                        data-dropdown-css-class="select2-lightblue" style="width: 100%;" required>
                                        <option disabled selected>Pilih Rute</option>
                                    </select>
                                    @error('rute_akhir')
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <button type="submit" class="btn btn-success float-right">Create Rute</button>
                    </div>
                </div>
            </form>
        </section>
